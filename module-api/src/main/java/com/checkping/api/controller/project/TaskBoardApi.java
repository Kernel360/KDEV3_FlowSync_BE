...
public interface TaskBoardApi {
    ...
    BaseResponse<TaskBoardGetItem.Response> register(
    ...
    BaseResponse<TaskBoardGetItem.Response> getTaskBoard(@Parameter(description = "게시글 ID") Long postId);

    @Operation(summary = "업무 관리 게시글 수정", description = "업무 관리 게시글을 수정하는 기능입니다.")
    BaseResponse<TaskBoardGetItem.Response> updateTaskBoard(@Parameter(description = "게시글 ID") Long postId,
